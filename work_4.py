...
def get_grades_average(course_name, *list):
    course_grades = []
    for i in range(len(list)):
        for j, k in list[i].grades.items():
            if course_name == j:
                course_grades += [k]
...
print(get_grades_average('Python', jerry, taker))
print(get_grades_average('Python', anita, tom))